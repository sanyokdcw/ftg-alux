...
for(var i = 0; i < document.querySelectorAll('.btn-contact2').length; i++) {
    document.querySelectorAll('.btn-contact2')[i].addEventListener("click", function(){
        document.querySelectorAll('.modal-adaptive-sidebar').removeClass('active')
    })
}
