...
">
  ...
  <div class="contact__wrapper">
    <div class="contact__wrapper-left">
      ...
      <a style="font-size:20px; width: 100%;" href="tel:{{ setting('contacts.telephone') }}" class="contact__wrapper-phone title">
        {{ setting('contacts.telephone') }}
      </a>
      <a style="font-size:20px; width:100%;"  href="tel:+77082150492" class="contact__wrapper-phone title">+7 708 215 04 92</a>
